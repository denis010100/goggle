...
const SearchResults = () => {
    ...
    return (
        <div className="max-w-3xl mt-10 p-4">
            ...
            <h1 className="text-2xl font-bold mb-4 mt-8">Search Results for "{query}"</h1>
            <p className="text-gray-700 mb-4">
                {totalResults} result{totalResults !== 1 ? 's' : ''} found from {searchData.length} items.
            </p>
            <p className="text-gray-500 mb-4">Search completed in {searchTime} ms.</p>
            {totalResults > 0 ? (
                <div>
                    <ul>
